...
function verif_SignUp() {
  if (
    ...
    document.getElementById("error").innerHTML =
      "<p> Fill all input fields !!</p>"; //modify the content of an HTML element
    ...
    document.getElementById("SignUp-email").value.includes("@") != true
  ) {
    //check if element invaild email
    ...
    document.getElementById("error").innerHTML =
      "<p> Fill Password field !!</p>"; //modify the content of an HTML element
    document.getElementById("error").style.color = "red"; //modify the style element
    document.getElementById("error").style.display = "block";
    return false;
  } //return statement, the function will stop executing
    ...
    document.getElementById("error").innerHTML =
      "<p> Fill Re-Password field !!</p>"; //modify the content of an HTML element
    document.getElementById("error").style.color = "red"; //modify the style element
    document.getElementById("error").style.display = "block";
    return false;
  } //return statement, the function will stop executing
...
function verif_LogIn() {
  ...
  else if (document.getElementById("login-name").value == "") {
    //check if element null
    document.getElementById("error").innerHTML = "<p> Fill name field !!</p>"; //modify the content of an HTML element
    document.getElementById("error").style.color = "red"; //modify the style element
    document.getElementById("error").style.display = "block";
    return false;
  } else if (document.getElementById("login-pass").value == "") {
    //check if element null
    document.getElementById("error").innerHTML =
      "<p> Fill Password field !!</p>"; //modify the content of an HTML element
    document.getElementById("error").style.color = "red"; //modify the style element
...
function verif_FeedBack() {
  if (
    ...
    document.getElementById("topics").value == 0
  ) {
    //check if element null
    document.getElementById("error").innerHTML =
      "<p> Fill all input fields !!</p>"; //modify the content of an HTML element
    ...
    //check if element null
    document.getElementById("error").innerHTML =
      "<p> Fill subject field !!</p>"; //modify the content of an HTML element
    document.getElementById("error").style.color = "red"; //modify the style element
    document.getElementById("error").style.display = "block";
    return false;
  } //return statement, the function will stop executing
    ...
    //check if element null
    document.getElementById("error").innerHTML =
      "<p> Fill message field !!</p>"; //modify the content of an HTML element
    document.getElementById("error").style.color = "red"; //modify the style element
    document.getElementById("error").style.display = "block";
    return false;
  } //return statement, the function will stop executing
  else if (document.getElementById("topics").value == 0) {
    //check if element null
...
function verif_CheckOut() {
  ...
  if (
    ...
    //check if element null
    document.getElementById("error").innerHTML =
      "<p> Fill name on card field !!</p>"; //modify the content of an HTML element
    document.getElementById("error").style.color = "red"; //modify the style element
    document.getElementById("error").style.display = "block";
    return false;
  } //return statement, the function will stop executing
    ...
    //check if element null
    document.getElementById("error").innerHTML =
      "<p> Fill credit card number field !!</p>"; //modify the content of an HTML element
    document.getElementById("error").style.color = "red"; //modify the style element
    document.getElementById("error").style.display = "block";
    return false;
  } //return statement, the function will stop executing
  else if (
    c.test(form1.login.value) != true ||
    document.getElementById("login").value.length != 16
  ) {
    document.getElementById("error").innerHTML =
      "<p> Invaild card number ,card number should be have 16 digits !!</p>"; //modify the content of an HTML element
    document.getElementById("error").style.color = "red"; //modify the style element
    document.getElementById("error").style.display = "block";
    return false;
  } //return statement, the function will stop executing
  else if (document.getElementById("exmonth").value == "") {
    //check if element null
    document.getElementById("error").innerHTML =
      "<p> Fill exp month field !!</p>"; //modify the content of an HTML element
    document.getElementById("error").style.color = "red"; //modify the style element
    document.getElementById("error").style.display = "block";
    return false;
  } //return statement, the function will stop executing
    ...
    document.getElementById("error").innerHTML =
      "<p> Fill exp year field !!</p>"; //modify the content of an HTML element
    document.getElementById("error").style.color = "red"; //modify the style element
    document.getElementById("error").style.display = "block";
    return false;
  } //return statement, the function will stop executing
  else if (
    c.test(form1.expyear.value) != true ||
    document.getElementById("expyear").value.length != 4
  ) {
